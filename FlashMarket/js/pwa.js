(() => {
  // Carrega a camada visual mobile em todas as páginas que usam o PWA.
  if (!document.querySelector('link[data-mobile-app-css]')) {
    const mobileCss = document.createElement('link');
    mobileCss.rel = 'stylesheet';
    mobileCss.href = 'css/mobile-app.css';
    mobileCss.dataset.mobileAppCss = 'true';
